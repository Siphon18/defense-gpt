"use client"
import { Lock, Mail, KeyRound, AlertTriangle, ArrowRight, Loader2 } from 'lucide-react'
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        ...
        >
          ...
          <p className="text-xs text-[#6b7280]">
            Sign in to continue your defense exam preparation
          </p>
        </motion.div>
      </div>
        ...
        >
          ...
          <div className="mt-6 text-center">
            <p className="text-xs text-[#6b7280]">
              ...
              <Link href="/signup" className="text-[#22c55e] hover:underline font-medium">
                Sign up
              </Link>
            </p>
          </div>
